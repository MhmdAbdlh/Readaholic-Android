...
class BookPageActivity : AppCompatActivity() , AdapterView.OnItemSelectedListener {
    ...
    override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
        ...
        if(flag == true) {
            ...
            Toast.makeText(this, "salma", Toast.LENGTH_SHORT).show()
        }
        flag = true
    }
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    fun request(shelf: Int) {
        var s = shelf
        Toast.makeText(this, s.toString(), Toast.LENGTH_LONG).show()
        if(shelf == 0){s = 2}
        else if(shelf == 2){s = 0}
        val queue = Volley.newRequestQueue(this)
        var url = Urls.ROOT+"/api/shelf/add_book"
        val stringRequest = object : StringRequest(Request.Method.POST, url,
            ...
            override fun getParams(): Map<String, String> {
                ...
                params["shelf_id"] = s.toString()
                params["book_id"] = Cbookdata.bookid.toString()
                params["token"] = UserInfo.sToken
                params["type"] = UserInfo.sTokenType
                return params
            }
        }
        queue.add(stringRequest)
